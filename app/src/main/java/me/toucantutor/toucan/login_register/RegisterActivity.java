...
public class RegisterActivity extends LoginActivity implements LoaderCallbacks<Cursor>,TaskCallback {
    ...
    private void doHttpTask(){
        ...
        if (!TextUtils.isEmpty(mcode.getText().toString())) {
            ...
            HttpTask checkCodeValid = new HttpTask(this, json, Constants.CHECK_CODE_VALID_URL);
    ...
    public void registerStudent() {
        ...
        HttpTask task = new HttpTask(this, new JsonObject(), Constants.STUDENT_REGISTER_URL);

    }

    public void registerTutor() {

        HttpTask task = new HttpTask(this, new JsonObject(), Constants.TUTOR_REGISTER_URL);
